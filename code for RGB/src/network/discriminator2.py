...
class Discriminator(nn.Module):
    def __init__(self, image_dims, context_dims, C, spectral_norm=True):
        ...
        self.conv11 = nn.Conv2d(filters[0], filters[0], kernel_size=3, padding=1, padding_mode='reflect')
        ...
        self.conv22 = nn.Conv2d(filters[1], filters[1], kernel_size=3, padding=1, padding_mode='reflect')
        ...
        self.conv33 = nn.Conv2d(filters[2], filters[2], kernel_size=3, padding=1, padding_mode='reflect')
        ...
        #self.conv44 = nn.Conv2d(filters[3], filters[3], kernel_size=3, padding=1, padding_mode='reflect')
    ...
    def forward(self, x, y):
        ...
        x = self.activation(self.conv33(x))
